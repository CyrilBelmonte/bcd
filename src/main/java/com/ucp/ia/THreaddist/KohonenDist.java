...
import com.ucp.ia.TextAnalysis;
 ...
 * @version 1.0.0.0;
 *
 * KohonenDist card code
 */

public class KohonenDist {
    ...
    private static int  dvp=7;
        ...
        private static int LEARNINGSIZE =5;
        private LinkedList<Integer> Entrychoosen;

    public KohonenDist(LinkedList<String> ingredients, LinkedList<Recipe> recipes, LinkedList<String> TitleList) {
...
/**
    ...
    public void Action(com.ucp.ia.Entry en) throws Exception  {
        ...
        for(Neuron neuron : kohonen) {
            ...
            */
            ...
            DistanceThread dt = new DistanceThread(neuron,en);
            DistancetitleThread dtt = new DistancetitleThread(neuron,en);
            ...
            distance = dt.getDistance()+dtt.getDistance();
        ...
        for(int index =0;index < kohonen.size() ; index++){
            ...
            for(int index2=0;index2 < sizetitle ; index2++){
                ...
                if(index == winner){
                    ...
                    learning = (epsilon * (entryweight - neuronweight) *voisin);
                }
