...
public class testia {
     public static void main(String[] args) {
         ...
         ingredientsall = DAOFactory.getIngredientDAO().getAllMainCoursesIngredients();
         /*
        ...
        */
         ...
         for(Ingredient ingredient : ingredientsall)
         {
            ...
            Kohonen kohonen = new Kohonen(ingredientsall,recipes);
                    kohonen.Clustering();
                    for(Categorie cat : kohonen.getCluster()) {
                        System.out.println("**************** NEXT CATEGORIE ****************");
                        for (Recipe recipe : cat.recipes) {
